...
shadowmapping_app::shadowmapping_app()
	: light_program(0),
	view_program(0),
...
void shadowmapping_app::init()
{
	static const char title[] = "Shadow Mapping";
...
void shadowmapping_app::startup()
{
	...
	{
		"../extern/media/objects/dragon.sbm",
		"../extern/media/objects/sphere.sbm",
		"../extern/media/objects/cube.sbm",
		"../extern/media/objects/torus.sbm"
	};
...
void shadowmapping_app::load_shaders()
{
	...
	shaders1[0] = sb7::shader::load("../extern/media/shaders/shadowmapping/shadowmapping-light.vs.glsl", GL_VERTEX_SHADER);
	shaders1[1] = sb7::shader::load("../extern/media/shaders/shadowmapping/shadowmapping-light.fs.glsl", GL_FRAGMENT_SHADER);
	light_program = sb7::program::link_from_shaders(shaders1, 2, true);
	...
	shaders2[0] = sb7::shader::load("../extern/media/shaders/shadowmapping/shadowmapping-camera.vs.glsl", GL_VERTEX_SHADER);
	shaders2[1] = sb7::shader::load("../extern/media/shaders/shadowmapping/shadowmapping-camera.fs.glsl", GL_FRAGMENT_SHADER);
	view_program = sb7::program::link_from_shaders(shaders2, 2, true);
	...
	shaders3[0] = sb7::shader::load("../extern/media/shaders/shadowmapping/shadowmapping-light-view.vs.glsl", GL_VERTEX_SHADER);
	shaders3[1] = sb7::shader::load("../extern/media/shaders/shadowmapping/shadowmapping-light-view.fs.glsl", GL_FRAGMENT_SHADER);
	show_light_depth_program = sb7::program::link_from_shaders(shaders3, 2, true);
