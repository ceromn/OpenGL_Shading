...
void bindlesstex_app::startup()
{
	...
	object.load("../extern/media/objects/torus_nrms_tc.sbm");
}
...
void bindlesstex_app::load_shaders()
{
	...
	shaders[0] = sb7::shader::load("../extern/media/shaders/bindlesstex/render.vs.glsl", GL_VERTEX_SHADER);
	shaders[1] = sb7::shader::load("../extern/media/shaders/bindlesstex/render.fs.glsl", GL_FRAGMENT_SHADER);
...
void bindlesstex_app::init()
{
	static const char title[] = "Bindless Textures";
