...
void dof_app::init()
{
	static const char title[] = "Depth Of Field";
...
void dof_app::load_shaders()
{
	...
	shaders1[0] = sb7::shader::load("../extern/media/shaders/dof/render.vs.glsl", GL_VERTEX_SHADER);
	shaders1[1] = sb7::shader::load("../extern/media/shaders/dof/render.fs.glsl", GL_FRAGMENT_SHADER);
	view_program = sb7::program::link_from_shaders(shaders1, 2, true);
	...
	shaders2[0] = sb7::shader::load("../extern/media/shaders/dof/display.vs.glsl", GL_VERTEX_SHADER);
	shaders2[1] = sb7::shader::load("../extern/media/shaders/dof/display.fs.glsl", GL_FRAGMENT_SHADER);
	display_program = sb7::program::link_from_shaders(shaders2, 2, true);
	...
	shaders3 = sb7::shader::load("../extern/media/shaders/dof/gensat.cs.glsl", GL_COMPUTE_SHADER);
	filter_program = sb7::program::link_from_shaders(&shaders3, 1, true);
}
