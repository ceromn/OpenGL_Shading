...
{
public:
	cubicbezier_app() : tess_program(0),
		draw_cp_program(0),
		show_points(false),
		show_cage(false),
		wireframe(false),
...
void cubicbezier_app::init()
{
	static const char title[] = "Cubic Bezier Patch";
...
void cubicbezier_app::load_shaders()
{
	...
	shaders1[0] = sb7::shader::load("../extern/media/shaders/cubicbezier/cubicbezier.vs.glsl", GL_VERTEX_SHADER);
	shaders1[1] = sb7::shader::load("../extern/media/shaders/cubicbezier/cubicbezier.tcs.glsl", GL_TESS_CONTROL_SHADER);
	shaders1[2] = sb7::shader::load("../extern/media/shaders/cubicbezier/cubicbezier.tes.glsl", GL_TESS_EVALUATION_SHADER);
	shaders1[3] = sb7::shader::load("../extern/media/shaders/cubicbezier/cubicbezier.fs.glsl", GL_FRAGMENT_SHADER);

	tess_program = sb7::program::link_from_shaders(shaders1, 4, true);
	...
	shaders2[0] = sb7::shader::load("../extern/media/shaders/cubicbezier/draw-control-points.vs.glsl", GL_VERTEX_SHADER);
	shaders2[1] = sb7::shader::load("../extern/media/shaders/cubicbezier/draw-control-points.fs.glsl", GL_FRAGMENT_SHADER);

	draw_cp_program = sb7::program::link_from_shaders(shaders2, 2, true);
