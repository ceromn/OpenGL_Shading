...
class starfield_app : public sb7::application
{
	void init()
	{
		static const char title[] = "Starfield";
	...
	void startup()
	{
		...
		//shaders1[1] = sb7::shader::load("../extern/media/shaders/render.fs.glsl", GL_FRAGMENT_SHADER);
		//render_prog = sb7::program::link_from_shaders(shaders1, 2, true);
		...
		star_texture = sb7::ktx::file::load("../extern/media/textures/star.ktx");
