...
void ssao_app::init()
{
	static const char title[] = "Screen-Space Ambient Occlusion";
...
void ssao_app::startup()
{
	...
	object.load("../extern/media/objects/dragon.sbm");
	cube.load("../extern/media/objects/cube.sbm");
...
void ssao_app::load_shaders()
{
	...
	shaders1[0] = sb7::shader::load("../extern/media/shaders/ssao/render.vs.glsl", GL_VERTEX_SHADER);
	shaders1[1] = sb7::shader::load("../extern/media/shaders/ssao/render.fs.glsl", GL_FRAGMENT_SHADER);
	...
	shaders2[0] = sb7::shader::load("../extern/media/shaders/ssao/ssao.vs.glsl", GL_VERTEX_SHADER);
	shaders2[1] = sb7::shader::load("../extern/media/shaders/ssao/ssao.fs.glsl", GL_FRAGMENT_SHADER);

	ssao_program = sb7::program::link_from_shaders(shaders2, 2, true);
